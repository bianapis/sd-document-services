...
/**
 * DocumentServicesAmendmentResponse
 */
public class DocumentServicesAmendmentResponse   {
  private String documentServicesSessionReference = null;

  private String documentAmendmentReference = null;
  ...
  **/
   ...
   * @return documentAmendmentReference
  **/

  public String getDocumentAmendmentReference() {
    return documentAmendmentReference;
  }

  public void setDocumentAmendmentReference(String documentAmendmentReference) {
    this.documentAmendmentReference = documentAmendmentReference;
  }
