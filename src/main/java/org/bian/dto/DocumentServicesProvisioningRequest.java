...
/**
 * DocumentServicesProvisioningRequest
 */
public class DocumentServicesProvisioningRequest   {
  ...
  **/
  ...
  /**
   * `status: Provisionally Registered` bian-reference: DocumentHandlingSession.DocumentHandlingSystem.SupportedProduct general-info:  document product or service action reference 
